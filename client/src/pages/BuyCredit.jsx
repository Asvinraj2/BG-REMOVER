  ...
  return (
    ...
    <div className='flex flex-wrap justify-center gap-6 text-left'>
      {plans.map((item,index) => (
        <div key={index}
            className='bg-white drop-shadow-sm border border-gray-200 rounded-lg py-12
            px-8 text-gray-700 hover:scale-105 transition-all duration-500'>
          ...
          <button className='w-full bg-gray-800 text-white mt-8
                text-sm rounded-md py-2.5 min-w-52' >Purchase</button>
        </div>
      ))}
    </div>
