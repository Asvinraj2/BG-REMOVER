...
const Header = () => {
  return (
    ...
    {/* ----------left side---------- */}
      ...
      <p className='my-6 text-[15px] text-gray-500'>Lorem Ipsum is asimple dummy text of the printing and typesetting industry. <br className='max-sm:hidden' /> and a dummy simple paragraph hahaha hahaha</p>
      <div>
